...
function [H,B,p,ntrigs,trig,lat]=get_PSTH_pop_int(parameter, DiscreteData,triglength_limit,ppms,time_before_trig,time_after_trig,exclude,safety_margin,binsize,isi,tail,trigstartend,varargin)
